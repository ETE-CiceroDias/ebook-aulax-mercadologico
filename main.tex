...
% ---------- Tipografia (corpo em sans, como no livro do MJV) ----------
\usepackage[scaled=0.96]{helvet}     % Helvetica/Nimbus — substituto livre do Univers/Vista Sans
...
% ============================================================================
%  PALETA  (extraída da capa-mercado.png — vinho / creme / sálvia / vermelho)
%  >>> Para mudar a identidade, ajuste apenas as cores abaixo. <<<
% ============================================================================
\definecolor{wineDeep}{HTML}{5C1519}   % vinho escuro — títulos e contraste
\definecolor{wine}{HTML}{7A1F1E}        % vinho — capa e cabeçalhos
\definecolor{redAccent}{HTML}{BC3B2C}   % vermelho — rótulos e destaques
\definecolor{sage}{HTML}{828C52}        % verde-sálvia — números e detalhes
\definecolor{sageSoft}{HTML}{A6AE78}    % sálvia clara
\definecolor{cream}{HTML}{F1EBDD}       % creme — fundos de bloco
\definecolor{creamMid}{HTML}{E5DECC}    % creme médio — linhas de tabela
\definecolor{ink}{HTML}{17161E}         % quase-preto azulado — texto
\definecolor{slate}{HTML}{6E5F5F}       % cinza-quente — rótulos e dados
...
% ============================================================================
%  ABERTURA DE SEÇÃO  (número grande à direita + título — estilo capítulo)
% ============================================================================
\titleformat{\section}[display]
  {\normalfont\sffamily}
  {\flushright\fontsize{84}{84}\selectfont\bfseries\color{sageSoft}\thesection}
  {6pt}
...
\newcommand{\novaSecao}[1]{\clearpage\vspace*{2.0cm}\section{#1}}

% Rótulo didático estilo MJV (O QUE É? / DE ONDE VEM? / COMO APLICAR?)
\newcommand{\rotulo}[1]{%
  \par\vspace{10pt}\noindent
  {\sffamily\bfseries\color{redAccent}\normalsize\MakeUppercase{#1}}\par\vspace{1pt}}
...
\fancypagestyle{corpo}{%
  ...
  \fancyhead[L]{\footnotesize\sffamily\textcolor{wineDeep}{\textbf{Empreendedorismo \& Mercado}}}
  \fancyhead[R]{\footnotesize\sffamily\textcolor{slate}{Material de apoio \textperiodcentered\ 4ª entrega}}
  \fancyfoot[L]{\footnotesize\sffamily\textcolor{slate}{\matInstituicao}}
  \fancyfoot[R]{\footnotesize\sffamily\textcolor{wineDeep}{\textbf{\thepage}}}
}

% ---------- Citação / definição em destaque (recuo + barra lateral) ----------
\newenvironment{citacaoBox}{%
  \par\vspace{6pt}%
  \def\FrameCommand{{\color{sage}\vrule width 2.5pt}\hspace{12pt}}%
...
% Nomes de legenda em PT (robusto, independe do babel)
...
% ============================================================================
\novaSecao{O que é empreendedorismo}
% ============================================================================
...
% ============================================================================
\novaSecao{Por que a análise mercadológica}
% ============================================================================
...
% ============================================================================
\novaSecao{Inovação e Diferencial Competitivo}\label{sec:diferencial}
% ============================================================================
\rotulo{O que é}
...
% ============================================================================
\novaSecao{A atividade da 4ª entrega}
% ============================================================================
